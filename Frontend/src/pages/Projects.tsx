...
export default function Projects() {
  const proyectos: ProyectoItem[] = [
    { titulo: "Aplicación Web: Vinoteca", descripcion: "Ecommerce de vinoteca con tienda pública, carrito, checkout con MercadoPago, seguimiento de pedidos y panel administrativo con gestión de productos, órdenes y estadísticas.", imageUrl: "images/proyects/vinoteca.png", tags: ["React", "TypeScript", "ASP.NET Core", "Entity Framework", "JWT", "MercadoPago", "SQL Server", "Tailwind"] },
