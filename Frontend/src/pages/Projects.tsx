...
export default function Projects() {
  const proyectos: ProyectoItem[] = [
    ...
    { titulo: "Aplicación Web: Gestión Veterinaria", descripcion: "Control de clientes, mascotas, turnos y expedientes.", imageUrl: "images/proyects/gestion-veterinaria.png", githubUrl: "https://github.com/oscar-principi/PetClinicApp", tags: ["C/C++", "Rlutil", "Archivos"] },
